package com.swcuriosity.memes.widget;
...
import com.swcuriosity.memes.multitouch.MoveGestureDetector;
import com.swcuriosity.memes.multitouch.RotateGestureDetector;
...
public class MotionView extends FrameLayout {
    ...
    public  void updateUIFromDesign() {
        invalidate();
    }
...
//        selectEntity(entity, true);
//    }
    public void updateSelectionOnTap(MotionEvent e) {
        MotionEntity entity = findEntityAtPoint(e.getX(), e.getY());
        selectEntity(entity, true);
    }
